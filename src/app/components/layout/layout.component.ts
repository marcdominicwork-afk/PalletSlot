          ...
          <div class="flex items-center justify-between h-16">
            ...
            <nav class="hidden md:flex items-center space-x-4">
              ...
              <div *ngIf="user && (user.role === 'admin' || user.role === 'company_admin')" class="relative">
                ...
                >
                  <span>Admin</span>
                  <svg class="w-4 h-4 transition-transform" [class.rotate-180]="isAdminMenuOpen" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <a
                    *ngFor="let item of getFilteredAdminLinks()"
